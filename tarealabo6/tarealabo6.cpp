#include <stdlib.h>//00030821, solamente intercambie valores y agregue para pedir q columna sumar
#include <iostream>//pddt: no pude arreglar lo de q las columnas se corren, aunq probe el codigo original y el de la clase y pasaba lo mismo
...
void HojaCalc::sumarcolum(int columna){
    nodo *s = pHE;
...
{
    nodo *s;
    int totFilas, totColumnas, fil, col, i, x=0;
    ...
    // la mariz se imprime por filas:
    hojaCalculo.imprimirHojaElec();
    cout << "Funcion de suma: \n";
    cout << "Que columna desea sumar?: "; cin>>x;
    hojaCalculo.sumarcolum(x);
